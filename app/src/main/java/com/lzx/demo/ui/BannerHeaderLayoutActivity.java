...
public class BannerHeaderLayoutActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLRecyclerView = (LRecyclerView) findViewById(R.id.list);
        ...
        //add a HeaderView
        mBanner = (Banner) LayoutInflater.from(this).inflate(R.layout.layout_banner_header,(ViewGroup)findViewById(android.R.id.content), false);
        ...
        mLRecyclerViewAdapter.addHeaderView(mBanner);
